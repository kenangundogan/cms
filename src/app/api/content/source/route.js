// src/app/api/content/source/route.js
...
export async function GET(req) {
    ...
    // Tüm veriler
    let allItems = [
        { "id": 1, "name": "Anadolu Ajansı", "shortname": "AA"},
        { "id": 2, "name": "İhlas Haber Ajansı", "shortname": "İHA"},
        { "id": 3, "name": "Demirören Haber Ajansı", "shortname": "DHA"},
        { "id": 4, "name": "Reuters", "shortname": "REUTERS"},
        { "id": 5, "name": "Associated Press", "shortname": "AP"},
        { "id": 6, "name": "British Broadcasting Corporation", "shortname": "BBC"},
        { "id": 7, "name": "Haberturk Web", "shortname": "Haberturk Web"},
        { "id": 8, "name": "Haberturk TV", "shortname": "Haberturk TV"},
    ];
    ...
    const createPaginationLinks = (currentPage, totalPages) => {
        ...
        // Previous link
        links.push({
            url: currentPage > 1 ? `/api/content/source?page=${currentPage - 1}` : null,
            label: "Previous",
            active: false,
        });
        ...
        if (endPage < totalPages) {
            ...
            links.push({
                url: `/api/content/source?page=${totalPages}`,
                label: `${totalPages}`,
        ...
        // Next link
        links.push({
            url: currentPage < totalPages ? `/api/content/source?page=${currentPage + 1}` : null,
            label: "Next",
            active: false,
        });
